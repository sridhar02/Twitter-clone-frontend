...
export default function TweetCard({ tweet }) {
    ...
    const user = {
        username: 'sridhar02',
        name: "JamesBond",
        profileImg: "https://media.gettyimages.com/photos/home-office-picture-id1193214720?k=6&m=1193214720&s=612x612&w=0&h=PG-IQkhXnBoKPFgErSLEwbDuAztvfXJjAg83tSr1RGA="
    }

    return (
        <div className={styles.container}>
            <img src={user.profileImg} alt="user profile logo" className={styles.profileImg} />
            <div>
